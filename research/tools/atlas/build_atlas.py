...
csv_path = "/home/shipa/Projects/Burnout3Recomp/src/docs/functions.csv"
out_path = "/home/shipa/Projects/Burnout3Recomp/src/docs/function-atlas.html"
...
<div class="wrap">
  <header class="page">
    <div class="eyebrow">Burnout3Recomp fork &middot; static analysis</div>
    ...
    <p class="dek">
      ...
      <strong>Grey means unnamed, not unbuilt</strong> &mdash; every one of these already compiles as
      real recompiled code in <code>Burnout3RecompLib</code>; what's missing is a human-readable name,
      not the code itself. Blue is stock Microsoft XDK library code Cxbx-Reloaded's own database already
      ...
      working. See
      <a href="https://github.com/shipa-2/Burnout3Recomp" target="_blank" rel="noopener">the repository</a>
      for methodology.
    </p>
  </header>
  ...
  <div class="stats">
    ...
    <div class="stat">
      ...
      <div class="l">compiled, not yet named</div>
    </div>
  </div>
  ...
  <div class="panel">
    <div class="panel-head">
      <div class="legend">
        <span class="item"><span class="swatch unknown"></span>Unnamed (still compiles)</span>
