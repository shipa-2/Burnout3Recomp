...
void KernelDispatch::Init()
{
    ...
    ThunkEntry thunks[] = {
        // Timing
        { 0xed874, "KeQuerySystemTime",              Kern_KeQuerySystemTime },
        { 0xed870, "RtlTimeToTimeFields",            Kern_RtlTimeToTimeFields },
        // 0xed878 = KeTickCount (DATA)
        { 0xed87c, "RtlTimeFieldsToTime",            Kern_RtlTimeFieldsToTime },
        // 0xed920 = ExEventObjectType (DATA)
        { 0xed864, "RtlInitAnsiString",              Kern_RtlInitAnsiString },

        // Synchronization
        { 0xed924, "NtSetEvent",                     Kern_NtSetEvent },
        { 0xed928, "NtPulseEvent",                   Kern_NtPulseEvent },
        { 0xed92c, "NtCreateSemaphore",              Kern_NtCreateSemaphore },
        { 0xed930, "NtReleaseSemaphore",             Kern_NtReleaseSemaphore },
        { 0xed934, "NtCreateMutant",                 Kern_NtCreateMutant },
        { 0xed938, "NtReleaseMutant",                Kern_NtReleaseMutant },
        { 0xed93c, "NtWaitForSingleObjectEx",        Kern_NtWaitForSingleObjectEx },
        { 0xed940, "KeDelayExecutionThread",         Kern_KeDelayExecutionThread },
        { 0xed960, "KfLowerIrql",                    Kern_KfLowerIrql },
        { 0xed968, "KeRaiseIrqlToDpcLevel",          Kern_KeRaiseIrqlToDpcLevel },
        { 0xed9bc, "KeSetTimerEx",                   Kern_KeSetTimerEx },
        { 0xed964, "KeQueryInterruptTime",           Kern_KeQueryInterruptTime },
        { 0xed8e8, "RtlLeaveCriticalSection",        Kern_RtlLeaveCriticalSection },
        { 0xed8ec, "RtlEnterCriticalSection",        Kern_RtlEnterCriticalSection },
        { 0xed99c, "KeWaitForMultipleObjects",       Kern_KeWaitForMultipleObjects },
        { 0xed978, "KeSetEvent",                     Kern_KeSetEvent },
        { 0xed970, "KeInitializeTimerEx",            Kern_KeInitializeTimerEx },
        { 0xed980, "KeWaitForSingleObject",          Kern_KeWaitForSingleObject },
        { 0xed9c4, "KeCancelTimer",                  Kern_KeCancelTimer },

        // Memory
        { 0xed840, "MmPersistContiguousMemory",      Kern_MmPersistContiguousMemory },
        { 0xed844, "MmAllocateContiguousMemory",     Kern_MmAllocateContiguousMemory },
        // 0xed848 = LaunchDataPage (DATA)
        { 0xed84c, "MmFreeContiguousMemory",         Kern_MmFreeContiguousMemory },

        // Rtl / HAL
        { 0xed850, "RtlNtStatusToDosError",          Kern_RtlNtStatusToDosError },
        { 0xed854, "HalReturnToFirmware",            Kern_HalReturnToFirmware },
        { 0xed8c0, "ExQueryNonVolatileSetting",      Kern_ExQueryNonVolatileSetting },

        // File I/O
        { 0xed858, "NtClose",                        Kern_NtClose },
        { 0xed8b0, "NtCreateFile",                   Kern_NtCreateFile },
        { 0xed85c, "NtSetInformationFile",           Kern_NtSetInformationFile },
        { 0xed860, "NtOpenFile",                     Kern_NtOpenFile },
        { 0xed86c, "NtQueryDirectoryFile",           Kern_NtQueryDirectoryFile },
        { 0xed868, "FscSetCacheSize",                Kern_FscSetCacheSize },
        { 0xed8b4, "NtWriteFile",                    Kern_NtWriteFile },
        { 0xed8b8, "NtReadFile",                     Kern_NtReadFile },
        { 0xed8bc, "NtQueryInformationFile",         Kern_NtQueryInformationFile },
        { 0xed90c, "NtWaitForSingleObject",          Kern_NtWaitForSingleObject },
        { 0xed8c4, "NtQueryVolumeInformationFile",   Kern_NtQueryVolumeInformationFile },
        { 0xed910, "NtFlushBuffersFile",             Kern_NtFlushBuffersFile },
        { 0xed914, "NtFsControlFile",                Kern_NtFsControlFile },
        { 0xed8d0, "NtDeviceIoControlFile",          Kern_NtDeviceIoControlFile },

        // Object manager
        { 0xed8f0, "ObfDereferenceObject",           Kern_ObfDereferenceObject },
        { 0xed8f8, "ObReferenceObjectByHandle",      Kern_ObReferenceObjectByHandle },

        // String
        { 0xeda04, "RtlAnsiStringToUnicodeString",   Kern_RtlAnsiStringToUnicodeString },

        // Timers / threads
        { 0xed95c, "KeSetTimer",                     Kern_KeSetTimer },
        { 0xed974, "KeInitializeDpc",                Kern_KeInitializeDpc },
        // 0xed8d4 = XboxHardwareInfo (DATA)
        { 0xed8f4, "KeSetBasePriorityThread",        Kern_KeSetBasePriorityThread },
        // 0xed8fc = PsThreadObjectType (DATA)
        { 0xed900, "RtlRaiseException",              Kern_RtlRaiseException },
        { 0xed904, "PsTerminateSystemThread",        Kern_PsTerminateSystemThread },
        { 0xed908, "PsCreateSystemThreadEx",         Kern_PsCreateSystemThreadEx },

        // Symbolic links
        { 0xed890, "IoCreateSymbolicLink",           Kern_IoCreateSymbolicLink },
        { 0xed894, "IoDeleteSymbolicLink",           Kern_IoDeleteSymbolicLink },
        { 0xed898, "NtQuerySymbolicLinkObject",      Kern_NtQuerySymbolicLinkObject },
        { 0xed89c, "NtOpenSymbolicLinkObject",       Kern_NtOpenSymbolicLinkObject },

        // Crypto
        { 0xed8a0, "XcSHAFinal",                    Kern_XcSHAFinal },
        { 0xed8a4, "XcSHAUpdate",                   Kern_XcSHAUpdate },
        { 0xed8a8, "XcSHAInit",                     Kern_XcSHAInit },
        { 0xed8c8, "XcVerifyPKCS1Signature",         Kern_Unknown },
        // 0xed8ac = XeImageFileName (DATA)
        // 0xed8cc = XePublicKeyData (DATA)
        // 0xeda08 = HalBootSMCVideoMode (DATA)
        { 0xed8d8, "HalRegisterShutdownNotification", Kern_HalRegisterShutdownNotification },
        { 0xed8dc, "MmSetAddressProtect",            Kern_MmSetAddressProtect },
        { 0xed8e0, "MmQueryAddressProtect",          Kern_MmQueryAddressProtect },
        // 0xed8e4 = XboxKrnlVersion (DATA)
        { 0xed994, "ExAllocatePoolWithTag",          Kern_ExAllocatePoolWithTag },
        { 0xed998, "ExFreePool",                     Kern_ExFreePool },
        { 0xed96c, "HalInitiateShutdown",            Kern_HalInitiateShutdown },
        { 0xed9e4, "HalGetInterruptVector",          Kern_HalGetInterruptVector },
        { 0xeda0c, "KfRaiseIrql",                    Kern_KfRaiseIrql },
        { 0xed9dc, "KeConnectInterrupt",             Kern_KeConnectInterrupt },
        { 0xed9e0, "KeInitializeInterrupt",          Kern_KeInitializeInterrupt },
        { 0xed9c8, "KeStallExecutionProcessor",      Kern_KeStallExecutionProcessor },
        { 0xed918, "XcHMAC",                         Kern_XcHMAC },
        // 0xed91c = XboxHDKey (DATA)
        { 0xed984, "MmAllocateContiguousMemoryEx",   Kern_MmAllocateContiguousMemoryEx },
        { 0xed988, "MmQueryAllocationSize",          Kern_MmQueryAllocationSize },
        { 0xed944, "RtlEqualString",                 Kern_RtlEqualString },
        { 0xed948, "XeLoadSection",                  Kern_XeLoadSection },
        { 0xed94c, "XeUnloadSection",                Kern_XeUnloadSection },
        // 0xed950 = HalDiskCachePartitionCount (DATA)
        { 0xed884, "NtFreeVirtualMemory",            Kern_NtFreeVirtualMemory },
        { 0xed880, "NtAllocateVirtualMemory",        Kern_NtAllocateVirtualMemory },
        { 0xed954, "RtlCompareMemoryUlong",          Kern_RtlCompareMemoryUlong },
        { 0xed958, "RtlInitializeCriticalSection",   Kern_RtlInitializeCriticalSection },
        { 0xed888, "NtQueryVirtualMemory",           Kern_NtQueryVirtualMemory },
        // 0xed97c = IdexChannelObject (DATA)
        { 0xed9d4, "MmGetPhysicalAddress",           Kern_MmGetPhysicalAddress },
        { 0xed9d0, "MmLockUnlockBufferPages",        Kern_MmLockUnlockBufferPages },
        { 0xed9cc, "KeInsertQueueDpc",               Kern_KeInsertQueueDpc },
        { 0xeda10, "MmLockUnlockPhysicalPage",       Kern_MmLockUnlockPhysicalPage },

        // AV
        { 0xeda1c, "AvSetSavedDataAddress",          Kern_AvSetSavedDataAddress },
        { 0xeda14, "AvGetSavedDataAddress",          Kern_AvGetSavedDataAddress },
        { 0xeda18, "AvSendTVEncoderOption",          Kern_AvSendTVEncoderOption },
        { 0xeda20, "AvSetDisplayMode",               Kern_AvSetDisplayMode },

        // HAL / PCI
        { 0xeda24, "HalReadWritePCISpace",           Kern_HalReadWritePCISpace },
        { 0xed9d8, "KeDisconnectInterrupt",          Kern_KeDisconnectInterrupt },
        { 0xeda2c, "DbgPrint",                       Kern_DbgPrint },
        { 0xeda28, "MmClaimGpuInstanceMemory",       Kern_MmClaimGpuInstanceMemory },
        { 0xeda30, "KeSaveFloatingPointState",       Kern_KeSaveFloatingPointState },
        { 0xeda34, "KeRestoreFloatingPointState",    Kern_KeRestoreFloatingPointState },
        { 0xeda38, "ExQueryPoolBlockSize",           Kern_ExQueryPoolBlockSize },
        { 0xed9c0, "KeRemoveQueueDpc",               Kern_KeRemoveQueueDpc },
        { 0xeda3c, "KeSynchronizeExecution",         Kern_KeSynchronizeExecution },

        // Network
        { 0xed98c, "PhyGetLinkState",                Kern_PhyGetLinkState },
        { 0xed990, "PhyInitialize",                  Kern_PhyInitialize },

        // Crypto
        { 0xed9a0, "XcDESKeyParity",                Kern_XcDESKeyParity },
        { 0xed9a4, "XcBlockCryptCBC",               Kern_XcBlockCryptCBC },
        { 0xed9a8, "XcKeyTable",                    Kern_XcKeyTable },
        { 0xed9ac, "XcModExp",                      Kern_XcModExp },
        // 0xed9b0 = XboxLANKey (DATA)
        { 0xed9b4, "XcRC4Crypt",                    Kern_XcRC4Crypt },
        { 0xed9b8, "XcRC4Key",                      Kern_XcRC4Key },

        // Performance counters
        { 0xed9e8, "KeQueryPerformanceCounter",      Kern_KeQueryPerformanceCounter },
        { 0xed9ec, "KeQueryPerformanceFrequency",    Kern_KeQueryPerformanceFrequency },
        // 0xed9f0 = HalDiskSerialNumber (DATA)
        // 0xed9f4 = HalDiskModelNumber (DATA)
        { 0xed88c, "MmQueryStatistics",              Kern_MmQueryStatistics },
        { 0xed9f8, "HalWriteSMBusValue",             Kern_HalWriteSMBusValue },
        { 0xed9fc, "RtlUnwind",                     Kern_RtlUnwind },
        { 0xeda00, "KeBugCheck",                     Kern_KeBugCheck },
    };
    ...
    // KeTickCount (4 bytes)
    // The guest GetTickCount() stub reads [[0xed878]], so the pointed-to value
    ...
    // to loop forever.
    {
        uint32_t addr = InitDataExport(0xed878, 4);
